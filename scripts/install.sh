...
# can parse.
SRC_SETS=".opencode skills hooks prompts docs/templates scripts/gate_runner.py scripts/gate_runner_guard.sh scripts/gate_errors.py scripts/gate_timeouts.py scripts/model_vendors.py scripts/proc_group.py scripts/gate_plausibility.py scripts/evidence_redaction.py scripts/verdict_findings.py scripts/verdict_currency.py scripts/verifier_evidence.py scripts/suite_outcome.py scripts/suite_command.py scripts/verifier_precheck.py scripts/verifier_attempts.py scripts/gate_ci.sh scripts/test_root_args.sh scripts/lint_gate.py scripts/env_file.py scripts/env_assemble.py scripts/pipeline_init.py scripts/load_env.sh scripts/mutation_score.py scripts/mutation_target.py scripts/spec_gate_cache.py scripts/spec_gate_context.py scripts/spec_gate_state.py scripts/spec_gate_triage.py scripts/spec_notes.py scripts/spec_rubric.py scripts/requirement_cap.py scripts/md_section.py scripts/measurement_claims.py scripts/carried_items.py scripts/done_when.py scripts/amendments.py scripts/applicability.py scripts/criticality.py scripts/breaker_gate.py scripts/required_skills.py scripts/subprocess_check.py scripts/fixture_shapes.py scripts/interface_drift.py scripts/doc_read_path.py scripts/pipeline_state.py scripts/pipeline_observations.py scripts/pipeline_metrics.py scripts/metrics_sink.py scripts/emission_gate.py scripts/override_classes.py scripts/plugin_release.py scripts/skill_contract.py scripts/stage_effort.py scripts/bypass_log.sh scripts/bypass_reason.sh scripts/codemap.py scripts/hook_spec_gate.sh scripts/hook_verifier.sh scripts/spec_done_guard.py scripts/hook_mutation.sh scripts/hook_artifact_check.sh scripts/phase_artifacts.py scripts/hook_ponytail.sh scripts/hook_lessons.sh scripts/hook_spec_rubric.sh scripts/hook_skills.sh scripts/hook_activity.sh scripts/hook_skill_load.sh scripts/hook_skill_audit.sh scripts/hook_autoapprove.sh scripts/hook_phase_close.sh scripts/hook_plugin_release.sh scripts/hook_implementer_lock.sh scripts/implementer_liveness.py scripts/hook_helper_budget.sh scripts/hook_helper_spend.sh scripts/helper_budget.py scripts/hook_auto_cleanup.sh cosmic-ray.toml .pre-commit-config.yaml .github/workflows/pipeline-gates.yml AGENTS.md scripts/mutation_scope.py scripts/guard_scope.py scripts/guard_scope.toml scripts/mutation_exec_guard.py scripts/behaviour_drift.py scripts/behaviour_atoms.py"
: > "$SRCLIST"
